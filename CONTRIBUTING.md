...
[ActiveLRS Code of Conduct](/blob//CODE_OF_CONDUCT.md).
...
- Open an [Bug Report Issue](/issues/new?template=bug_report.md) using our **Bug Report template**. *(Since we can't be sure at this point whether it is a bug or not, please do **not** label the issue or claim it is a bug outside of this template.)*
...
- Open a new [Feature Request issue](/issues/new?template=feature_request.md) using our **Feature Request template**.
...
- Open a new [Documentation Issue](/issues/new?template=documentation_issue.md) using the **Documentation Issue template**.
...
- Open a new [Question / Discussion issue](/issues/new?template=question_discussion.md) using the **Question / Discussion template**.
- Provide context, examples, and any steps you’ve already tried.


### Pull Requests / Code Contributions

- When submitting code changes, always use the [Pull Request template](/pull/new/main) to guide your PR description.
- Include:
...
1. **Start by contributing issues or documentation improvements**.  
   Use the templates in `.github/` to submit bug reports, feature requests, or documentation updates.
